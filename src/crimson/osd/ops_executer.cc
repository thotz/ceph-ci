...
OpsExecuter::interruptible_call_errorator::future<> OpsExecuter::do_op_call(OSDOp& osd_op)
{
...
OpsExecuter::interruptible_watch_errorator::future<> OpsExecuter::do_op_watch_subop_watch(
  OSDOp& osd_op,
  ObjectState& os,
...
OpsExecuter::interruptible_watch_errorator::future<> OpsExecuter::do_op_watch_subop_reconnect(
  OSDOp& osd_op,
  ObjectState& os,
  ceph::os::Transaction& txn)
{
...
OpsExecuter::interruptible_watch_errorator::future<> OpsExecuter::do_op_watch_subop_unwatch(
  OSDOp& osd_op,
  ObjectState& os,
  ceph::os::Transaction& txn)
{
...
OpsExecuter::interruptible_watch_errorator::future<> OpsExecuter::do_op_watch_subop_ping(
  OSDOp& osd_op,
  ObjectState& os,
  ceph::os::Transaction& txn)
{
...
OpsExecuter::interruptible_watch_errorator::future<> OpsExecuter::do_op_watch(
  OSDOp& osd_op,
  ObjectState& os,
  ceph::os::Transaction& txn)
{
...
OpsExecuter::interruptible_watch_errorator::future<> OpsExecuter::do_op_notify(
  OSDOp& osd_op,
...
OpsExecuter::interruptible_watch_errorator::future<> OpsExecuter::do_op_notify_ack(
  OSDOp& osd_op,
  const ObjectState& os)
{
  logger().debug("{}", __func__);
