...
class OpsExecuter {
  ...
  using interruptible_call_errorator =
  ...
  using interruptible_watch_errorator =
    ::crimson::interruptible::interruptible_errorator<
...
public:
  ...
  using interruptible_osd_op_errorator =
    ::crimson::interruptible::interruptible_errorator<
...
private:
  ...
  interruptible_call_errorator::future<> do_op_call(class OSDOp& osd_op);
  interruptible_watch_errorator::future<> do_op_watch(
    class OSDOp& osd_op,
    class ObjectState& os,
    ceph::os::Transaction& txn);
  interruptible_watch_errorator::future<> do_op_watch_subop_watch(
    class OSDOp& osd_op,
    class ObjectState& os,
    ceph::os::Transaction& txn);
  interruptible_watch_errorator::future<> do_op_watch_subop_reconnect(
    class OSDOp& osd_op,
    class ObjectState& os,
    ceph::os::Transaction& txn);
  interruptible_watch_errorator::future<> do_op_watch_subop_unwatch(
    class OSDOp& osd_op,
    class ObjectState& os,
    ceph::os::Transaction& txn);
  interruptible_watch_errorator::future<> do_op_watch_subop_ping(
    class OSDOp& osd_op,
    class ObjectState& os,
    ceph::os::Transaction& txn);
  interruptible_watch_errorator::future<> do_op_notify(
    class OSDOp& osd_op,
    const class ObjectState& os);
  interruptible_watch_errorator::future<> do_op_notify_ack(
    class OSDOp& osd_op,
    const class ObjectState& os);
...
public:
  ...
  interruptible_osd_op_errorator::future<> flush_changes(Func&& func, MutFunc&& mut_func) &&;
...
template <typename Func,
          typename MutFunc>
OpsExecuter::interruptible_osd_op_errorator::future<> OpsExecuter::flush_changes(
  Func&& func,
  MutFunc&& mut_func) &&
{
  assert(obc);
