...
PGBackend::interruptible_load_metadata_ertr::future
...
PGBackend::interruptible_read_errorator::future<>
PGBackend::read(const ObjectState& os, OSDOp& osd_op)
{
  ...
  return _read(oi.soid, offset, length, op.flags).safe_then_interruptible(
  ...
  return interruptor::make_interruptible(store->fiemap(coll, ghobject_t{os.oi.soid},
    ...
    return seastar::do_with(interval_set<uint64_t>{std::move(m)},
      ...
      return interruptor::make_interruptible(store->readv(coll, ghobject_t{os.oi.soid},
                          extents, osd_op.op.flags)).safe_then_interruptible(
...
PGBackend::interruptible_checksum_errorator::future<>
...
PGBackend::interruptible_cmp_ext_errorator::future<>
PGBackend::cmp_ext(const ObjectState& os, OSDOp& osd_op)
{
  ...
  auto read_ext = interruptible_ll_read_errorator::make_ready_future<ceph::bufferlist>();
  if (ext_len == 0) {
...
PGBackend::interruptible_stat_errorator::future<>
PGBackend::stat(
...
PGBackend::interruptible_append_errorator::future<> PGBackend::append(
  ObjectState& os,
  OSDOp& osd_op,
  ceph::os::Transaction& txn,
  osd_op_params_t& osd_op_params)
...
PGBackend::interruptible_write_ertr::future<> PGBackend::truncate(
  ObjectState& os,
  const OSDOp& osd_op,
  ceph::os::Transaction& txn,
  osd_op_params_t& osd_op_params)
...
PGBackend::interruptible_write_ertr::future<> PGBackend::zero(
  ObjectState& os,
  const OSDOp& osd_op,
  ceph::os::Transaction& txn,
  osd_op_params_t& osd_op_params)
...
PGBackend::interruptible_get_attr_errorator::future<> PGBackend::getxattr(
  const ObjectState& os,
  OSDOp& osd_op) const
{
  std::string name;
...
PGBackend::interruptible_get_attr_errorator::future<ceph::bufferptr>
PGBackend::getxattr(
...
PGBackend::interruptible_get_attr_errorator::future<> PGBackend::get_xattrs(
  const ObjectState& os,
  OSDOp& osd_op) const
{
  if (__builtin_expect(stopping, false)) {
...
PGBackend::interruptible_rm_xattr_ertr::future<>
PGBackend::rm_xattr(
  ObjectState& os,
  OSDOp& osd_op,
  ceph::os::Transaction& txn)
{
  ...
  return interruptible_rm_xattr_ertr::now();
}

using get_omap_ertr =
  crimson::os::FuturizedStore::read_errorator::extend<
    crimson::ct_error::enodata>;
using interruptible_get_omap_ertr =
  ::crimson::interruptible::interruptible_errorator<
    ::crimson::osd::IOInterruptCondition,
    get_omap_ertr>;
static
interruptible_get_omap_ertr::future<
...
PGBackend::interruptible_future<ceph::bufferlist>
...
PGBackend::omap_get_header(
  ...
  OSDOp& osd_op) const
{
  return omap_get_header(coll, ghobject_t{os.oi.soid}).then_interruptible(
...
PGBackend::interruptible_ll_read_errorator::future<>
...
PGBackend::interruptible_omap_clear_ertr::future<>
