...
void RGWOp_Bucket_Info::execute(const jspan* const parent_span)
{
...
void RGWOp_Get_Policy::execute(const jspan* const parent_span)
{
  RGWBucketAdminOpState op_state;
...
void RGWOp_Check_Bucket_Index::execute(const jspan* const parent_span)
{
  std::string bucket;
...
void RGWOp_Bucket_Link::execute(const jspan* const parent_span)
{
  std::string uid_str;
  std::string bucket;
...
void RGWOp_Bucket_Unlink::execute(const jspan* const parent_span)
{
  std::string uid_str;
  std::string bucket;
...
void RGWOp_Bucket_Remove::execute(const jspan* const parent_span)
{
...
void RGWOp_Set_Bucket_Quota::execute(const jspan* const parent_span)
{
...
void RGWOp_Sync_Bucket::execute(const jspan* const parent_span)
{
  std::string bucket;
  std::string tenant;
  bool sync_bucket;
...
void RGWOp_Object_Remove::execute(const jspan* const parent_span)
{
  std::string bucket;
  std::string object;
