...
int RGWGetObj_ObjStore_S3Website::send_response_data(bufferlist& bl, off_t bl_ofs, off_t bl_len, const jspan* const parent_span) {
...
int RGWGetObj_ObjStore_S3Website::send_response_data_error(const jspan* const parent_span)
{
  return RGWGetObj_ObjStore_S3::send_response_data_error();
}

int RGWGetObj_ObjStore_S3::get_params(const jspan* const parent_span)
{
...
int RGWGetObj_ObjStore_S3::send_response_data_error(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");

  bufferlist bl;
  return send_response_data(bl, 0 , 0, span.get());
}
...
int RGWGetObj_ObjStore_S3::send_response_data(bufferlist& bl, off_t bl_ofs,
					      off_t bl_len, const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWGetObjTags_ObjStore_S3::send_response_data(bufferlist& bl, const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
int RGWPutObjTags_ObjStore_S3::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
  RGWXMLParser parser;
...
void RGWPutObjTags_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWDeleteObjTags_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
void RGWGetBucketTags_ObjStore_S3::send_response_data(bufferlist& bl, const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
int RGWPutBucketTags_ObjStore_S3::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
void RGWPutBucketTags_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWDeleteBucketTags_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWGetBucketReplication_ObjStore_S3::send_response_data(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
int RGWPutBucketReplication_ObjStore_S3::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
void RGWPutBucketReplication_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWDeleteBucketReplication_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
void RGWListBuckets_ObjStore_S3::send_response_begin(bool has_buckets, const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWListBuckets_ObjStore_S3::send_response_data(rgw::sal::RGWBucketList& buckets, const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWListBuckets_ObjStore_S3::send_response_end(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
int RGWGetUsage_ObjStore_S3::get_params(const jspan* const parent_span)
{
...
void RGWGetUsage_ObjStore_S3::send_response(const jspan* const parent_span)
{
  if (op_ret < 0)
    set_req_state_err(s, op_ret);
  dump_errno(s);
...
int RGWListBucket_ObjStore_S3::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
int RGWListBucket_ObjStore_S3v2::get_params(const jspan* const parent_span)
{
...
void RGWListBucket_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
  ...
  if (list_versions) {
    send_versioned_response(span.get());
    return;
  }
  ...
  RGWListBucket_ObjStore_S3::send_common_response(span.get());
    if (op_ret >= 0) {
      vector<rgw_bucket_dir_entry>::iterator iter;
      for (iter = objs.begin(); iter != objs.end(); ++iter) {
        rgw_obj_key key(iter->key);
...
void RGWListBucket_ObjStore_S3v2::send_response(const jspan* const parent_span)
{
  if (op_ret < 0) {
    set_req_state_err(s, op_ret);
  }
...
void RGWGetBucketLogging_ObjStore_S3::send_response(const jspan* const parent_span)
{
  dump_errno(s);
  end_header(s, this, "application/xml");
  dump_start(s);
...
void RGWGetBucketLocation_ObjStore_S3::send_response(const jspan* const parent_span)
{
  dump_errno(s);
  end_header(s, this);
  dump_start(s);
...
void RGWGetBucketVersioning_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
int RGWSetBucketVersioning_ObjStore_S3::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
void RGWSetBucketVersioning_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
int RGWSetBucketWebsite_ObjStore_S3::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
void RGWSetBucketWebsite_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWDeleteBucketWebsite_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
void RGWGetBucketWebsite_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
void RGWStatBucket_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
int RGWCreateBucket_ObjStore_S3::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
void RGWCreateBucket_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWDeleteBucket_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
int RGWPutObj_ObjStore_S3::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWPutObj_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
int RGWPostObj_ObjStore_S3::get_params(const jspan* const parent_span)
{
...
void RGWPostObj_ObjStore_S3::send_response(const jspan* const parent_span)
{
...
int RGWDeleteObj_ObjStore_S3::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
void RGWDeleteObj_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
int RGWCopyObj_ObjStore_S3::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
void RGWCopyObj_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");

  if (!sent_header)
    send_partial_response(0, span.get());
...
void RGWGetACLs_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
int RGWPutACLs_ObjStore_S3::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
void RGWPutACLs_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWGetLC_ObjStore_S3::execute(const jspan* const parent_span)
{
...
void RGWGetLC_ObjStore_S3::send_response(const jspan* const parent_span)
{
  if (op_ret) {
    if (op_ret == -ENOENT) {
...
void RGWPutLC_ObjStore_S3::send_response(const jspan* const parent_span)
{
  if (op_ret)
    set_req_state_err(s, op_ret);
  dump_errno(s);
...
void RGWDeleteLC_ObjStore_S3::send_response(const jspan* const parent_span)
{
  if (op_ret == 0)
      op_ret = STATUS_NO_CONTENT;
  if (op_ret) {
...
void RGWGetCORS_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
int RGWPutCORS_ObjStore_S3::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWPutCORS_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWDeleteCORS_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
void RGWOptionsCORS_ObjStore_S3::send_response(const jspan* const parent_span)
{
...
void RGWGetRequestPayment_ObjStore_S3::send_response(const jspan* const parent_span)
{
  dump_errno(s);
  end_header(s, this, "application/xml");
  dump_start(s);
...
int RGWSetRequestPayment_ObjStore_S3::get_params(const jspan* const parent_span)
{
  const auto max_size = s->cct->_conf->rgw_max_put_param_size;
...
void RGWSetRequestPayment_ObjStore_S3::send_response(const jspan* const parent_span)
{
  if (op_ret)
    set_req_state_err(s, op_ret);
  dump_errno(s);
...
int RGWInitMultipart_ObjStore_S3::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
void RGWInitMultipart_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
int RGWCompleteMultipart_ObjStore_S3::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
...
void RGWCompleteMultipart_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWAbortMultipart_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWListMultipart_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWListBucketMultiparts_ObjStore_S3::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "s3");
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
int RGWDeleteMultiObj_ObjStore_S3::get_params(const jspan* const parent_span)
{
...
void RGWGetObjLayout_ObjStore_S3::send_response(const jspan* const parent_span)
{
  if (op_ret)
    set_req_state_err(s, op_ret);
  dump_errno(s);
...
int RGWConfigBucketMetaSearch_ObjStore_S3::get_params(const jspan* const parent_span)
{
...
void RGWConfigBucketMetaSearch_ObjStore_S3::send_response(const jspan* const parent_span)
{
  if (op_ret)
    set_req_state_err(s, op_ret);
  dump_errno(s);
...
void RGWGetBucketMetaSearch_ObjStore_S3::send_response(const jspan* const parent_span)
{
  if (op_ret)
    set_req_state_err(s, op_ret);
  dump_errno(s);
...
void RGWDelBucketMetaSearch_ObjStore_S3::send_response(const jspan* const parent_span)
{
  if (op_ret)
    set_req_state_err(s, op_ret);
  dump_errno(s);
...
void RGWPutBucketObjectLock_ObjStore_S3::send_response(const jspan* const parent_span)
{
  if (op_ret) {
    set_req_state_err(s, op_ret);
  }
...
void RGWGetBucketObjectLock_ObjStore_S3::send_response(const jspan* const parent_span)
{
  if (op_ret) {
    set_req_state_err(s, op_ret);
  }
...
int RGWPutObjRetention_ObjStore_S3::get_params(const jspan* const parent_span)
{
  const char *bypass_gov_header = s->info.env->get("HTTP_X_AMZ_BYPASS_GOVERNANCE_RETENTION");
  if (bypass_gov_header) {
    std::string bypass_gov_decoded = url_decode(bypass_gov_header);
...
void RGWPutObjRetention_ObjStore_S3::send_response(const jspan* const parent_span)
{
  if (op_ret) {
    set_req_state_err(s, op_ret);
  }
...
void RGWGetObjRetention_ObjStore_S3::send_response(const jspan* const parent_span)
{
  if (op_ret) {
    set_req_state_err(s, op_ret);
  }
...
void RGWPutObjLegalHold_ObjStore_S3::send_response(const jspan* const parent_span)
{
  if (op_ret) {
    set_req_state_err(s, op_ret);
  }
...
void RGWGetObjLegalHold_ObjStore_S3::send_response(const jspan* const parent_span)
{
  if (op_ret) {
    set_req_state_err(s, op_ret);
  }
...
void RGWGetBucketPolicyStatus_ObjStore_S3::send_response(const jspan* const parent_span)
{
  if (op_ret) {
    set_req_state_err(s, op_ret);
  }
...
void RGWPutBucketPublicAccessBlock_ObjStore_S3::send_response(const jspan* const parent_span)
{
  if (op_ret) {
    set_req_state_err(s, op_ret);
  }
...
void RGWGetBucketPublicAccessBlock_ObjStore_S3::send_response(const jspan* const parent_span)
{
  if (op_ret) {
    set_req_state_err(s, op_ret);
  }
...
int RGWSelectObj_ObjStore_S3::get_params(const jspan* const parent_span)
{
...
int RGWSelectObj_ObjStore_S3::send_response_data(bufferlist& bl, off_t ofs, off_t len, const jspan* const parent_span)
{
  if (len == 0) {
    return 0;
  }
