...
int RGWRestRole::verify_permission(const jspan* const parent_span)
{
...
void RGWRestRole::send_response(const jspan* const parent_span)
{
  if (op_ret) {
...
int RGWCreateRole::verify_permission(const jspan* const parent_span)
{
  if (s->auth.identity->is_anonymous()) {
    return -EACCES;
  }
...
void RGWCreateRole::execute(const jspan* const parent_span)
{
  op_ret = get_params();
  if (op_ret < 0) {
    return;
...
void RGWDeleteRole::execute(const jspan* const parent_span)
{
  op_ret = get_params();
  if (op_ret < 0) {
    return;
...
int RGWGetRole::verify_permission(const jspan* const parent_span)
{
  return 0;
}
...
void RGWGetRole::execute(const jspan* const parent_span)
{
  op_ret = get_params();
  if (op_ret < 0) {
    return;
...
void RGWModifyRole::execute(const jspan* const parent_span)
{
  op_ret = get_params();
  if (op_ret < 0) {
    return;
...
int RGWListRoles::verify_permission(const jspan* const parent_span)
{
  if (s->auth.identity->is_anonymous()) {
    return -EACCES;
  }
...
void RGWListRoles::execute(const jspan* const parent_span)
{
  op_ret = get_params();
  if (op_ret < 0) {
    return;
...
void RGWPutRolePolicy::execute(const jspan* const parent_span)
{
  op_ret = get_params();
  if (op_ret < 0) {
    return;
...
void RGWGetRolePolicy::execute(const jspan* const parent_span)
{
  op_ret = get_params();
  if (op_ret < 0) {
    return;
...
void RGWListRolePolicies::execute(const jspan* const parent_span)
{
  op_ret = get_params();
  if (op_ret < 0) {
    return;
...
void RGWDeleteRolePolicy::execute(const jspan* const parent_span)
{
  op_ret = get_params();
  if (op_ret < 0) {
    return;
