...
int RGWListBuckets_ObjStore_SWIFT::get_params(const jspan* const parent_span)
{
...
void RGWListBuckets_ObjStore_SWIFT::send_response_begin(bool has_buckets, const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWListBuckets_ObjStore_SWIFT::send_response_data(rgw::sal::RGWBucketList& buckets, const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWListBuckets_ObjStore_SWIFT::send_response_data_reversed(rgw::sal::RGWBucketList& buckets, const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWListBuckets_ObjStore_SWIFT::send_response_end(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
int RGWListBucket_ObjStore_SWIFT::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "swift");
...
void RGWListBucket_ObjStore_SWIFT::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWStatAccount_ObjStore_SWIFT::execute(const jspan* const parent_span)
{
  RGWStatAccount_ObjStore::execute();
  op_ret = store->ctl()->user->get_attrs_by_uid(s->user->get_id(), &attrs, s->yield);
}

void RGWStatAccount_ObjStore_SWIFT::send_response(const jspan* const parent_span)
{
  if (op_ret >= 0) {
    op_ret = STATUS_NO_CONTENT;
    dump_account_metadata(s,
...
void RGWStatBucket_ObjStore_SWIFT::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "swift");
...
int RGWCreateBucket_ObjStore_SWIFT::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "swift");
...
void RGWCreateBucket_ObjStore_SWIFT::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWDeleteBucket_ObjStore_SWIFT::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "swift");
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
int RGWPutObj_ObjStore_SWIFT::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "swift");
...
int RGWPutObj_ObjStore_SWIFT::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "swift");
...
void RGWPutObj_ObjStore_SWIFT::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
int RGWPutMetadataAccount_ObjStore_SWIFT::get_params(const jspan* const parent_span)
{
  if (s->has_bad_meta) {
    return -EINVAL;
  }
...
void RGWPutMetadataAccount_ObjStore_SWIFT::send_response(const jspan* const parent_span)
{
  const auto meta_ret = handle_metadata_errors(s, op_ret);
  if (meta_ret != op_ret) {
    op_ret = meta_ret;
...
int RGWPutMetadataBucket_ObjStore_SWIFT::get_params(const jspan* const parent_span)
{
  if (s->has_bad_meta) {
    return -EINVAL;
  }
...
void RGWPutMetadataBucket_ObjStore_SWIFT::send_response(const jspan* const parent_span)
{
  const auto meta_ret = handle_metadata_errors(s, op_ret);
  if (meta_ret != op_ret) {
    op_ret = meta_ret;
...
int RGWPutMetadataObject_ObjStore_SWIFT::get_params(const jspan* const parent_span)
{
  if (s->has_bad_meta) {
    return -EINVAL;
  }
...
void RGWPutMetadataObject_ObjStore_SWIFT::send_response(const jspan* const parent_span)
{
  const auto meta_ret = handle_metadata_errors(s, op_ret);
  if (meta_ret != op_ret) {
    op_ret = meta_ret;
...
int RGWDeleteObj_ObjStore_SWIFT::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "swift");
...
int RGWDeleteObj_ObjStore_SWIFT::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "swift");
...
void RGWDeleteObj_ObjStore_SWIFT::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
int RGWCopyObj_ObjStore_SWIFT::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "swift");
...
void RGWCopyObj_ObjStore_SWIFT::send_response(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
int RGWGetObj_ObjStore_SWIFT::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "swift");
...
int RGWGetObj_ObjStore_SWIFT::get_params(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "gateway", "swift");
...
int RGWGetObj_ObjStore_SWIFT::send_response_data_error(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
int RGWGetObj_ObjStore_SWIFT::send_response_data(bufferlist& bl,
                                                 const off_t bl_ofs,
                                                 const off_t bl_len, const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  jaeger_tracing::set_span_tag(s->root_span.get(), "success", "true");
...
void RGWOptionsCORS_ObjStore_SWIFT::send_response(const jspan* const parent_span)
{
...
void RGWBulkDelete_ObjStore_SWIFT::send_response(const jspan* const parent_span)
{
  set_req_state_err(s, op_ret);
  dump_errno(s);
  end_header(s, this /* RGWOp */, nullptr /* contype */,
...
void RGWBulkUploadOp_ObjStore_SWIFT::send_response(const jspan* const parent_span)
{
  set_req_state_err(s, op_ret);
  dump_errno(s);
  end_header(s, this /* RGWOp */, nullptr /* contype */,
...
void RGWGetCrossDomainPolicy_ObjStore_SWIFT::send_response(const jspan* const parent_span)
{
  set_req_state_err(s, op_ret);
  dump_errno(s);
...
void RGWGetHealthCheck_ObjStore_SWIFT::send_response(const jspan* const parent_span)
{
  set_req_state_err(s, op_ret);
  dump_errno(s);
  end_header(s, this, "application/xml");
...
void RGWInfo_ObjStore_SWIFT::execute(const jspan* const parent_span)
{
...
void RGWInfo_ObjStore_SWIFT::send_response(const jspan* const parent_span)
{
  if (op_ret <  0) {
    op_ret = STATUS_NO_CONTENT;
  }
...
int RGWFormPost::get_params(const jspan* const parent_span)
{
...
int RGWFormPost::get_data(ceph::bufferlist& bl, bool& again)
{
  ...
  /* Tell RGWPostObj::execute(const jspan* const parent_span) that it has some data to put. */
  again = !boundary;

  return bl.length();
}

void RGWFormPost::send_response(const jspan* const parent_span)
{
...
RGWOp* RGWSwiftWebsiteHandler::get_ws_redirect_op()
{
  ...
  public:
   ...
   int verify_permission(const jspan* const parent_span = nullptr) override {
      return 0;
    }

    void execute(const jspan* const parent_span = nullptr) override {
      op_ret = -ERR_PERMANENT_REDIRECT;
      return;
    }

    void send_response(const jspan* const parent_span = nullptr) override {
      set_req_state_err(s, op_ret);
      dump_errno(s);
      dump_content_length(s, 0);
...
RGWOp* RGWSwiftWebsiteHandler::get_ws_listing_op()
{
  class RGWWebsiteListing : public RGWListBucket_ObjStore_SWIFT {
    ...
    int get_params(const jspan* const parent_span = nullptr) override {
