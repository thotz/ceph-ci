...
void RGWOp_Period_Base::send_response(const jspan* const parent_span)
{
...
void RGWOp_Period_Get::execute(const jspan* const parent_span)
{
...
void RGWOp_Period_Post::execute(const jspan* const parent_span)
{
  auto cct = store->ctx();
...
void RGWOp_Realm_Get::execute(const jspan* const parent_span)
{
  string id;
...
void RGWOp_Realm_Get::send_response(const jspan* const parent_span)
{
...
void RGWOp_Realm_List::execute(const jspan* const parent_span)
{
  {
    // read default realm
...
void RGWOp_Realm_List::send_response(const jspan* const parent_span)
{
  set_req_state_err(s, op_ret);
  dump_errno(s);
