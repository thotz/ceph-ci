...
void RGWOp_ZoneGroupMap_Get::execute(const jspan* const parent_span) {
...
void RGWOp_ZoneGroupMap_Get::send_response(const jspan* const parent_span) {
...
void RGWOp_ZoneConfig_Get::send_response(const jspan* const parent_span) {
