...
public:
  ...
  int send_response_data(bufferlist& bl, off_t ofs, off_t len, const jspan* const parent_span = nullptr) override;
...
public:
  ...
  void send_response_data(bufferlist &bl, const jspan* const parent_span = nullptr) override;
};
...
{
public:
  void send_response_data(const jspan* const parent_span = nullptr) override;
};
...
public:
  ...
  virtual int send_response_data(bufferlist& bl, off_t ofs, off_t len, const jspan* const parent_span = nullptr) override;

  virtual int get_params(const jspan* const parent_span = nullptr) override;
