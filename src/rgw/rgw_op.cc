...
static int read_bucket_policy(rgw::sal::RGWStore *store,
                              ...
                              map<string, bufferlist>& bucket_attrs,
                              RGWAccessControlPolicy *policy,
                              rgw_bucket& bucket, const jspan* const parent_span = nullptr)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
 ...
 * Returns: 0 on success, -ERR# otherwise.
 */
int rgw_build_bucket_policies(rgw::sal::RGWRadosStore* store, struct req_state* s, const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  int ret = 0;
...
int rgw_build_object_policies(rgw::sal::RGWRadosStore *store, struct req_state *s,
			      bool prefetch_data, const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWGetObj::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWOp::verify_op_mask(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWGetObjTags::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWGetObjTags::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}

void RGWGetObjTags::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWPutObjTags::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWPutObjTags::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWDeleteObjTags::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWDeleteObjTags::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWDeleteObjTags::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWGetBucketTags::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWGetBucketTags::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWGetBucketTags::execute(const jspan* const parent_span) 
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWPutBucketTags::verify_permission(const jspan* const parent_span) {
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);

  return verify_bucket_owner_or_policy(s, rgw::IAM::s3PutBucketTagging);
}

void RGWPutBucketTags::execute(const jspan* const parent_span) {
...
void RGWDeleteBucketTags::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWDeleteBucketTags::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWDeleteBucketTags::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  bufferlist in_data;
  op_ret = store->forward_request_to_master(s->user.get(), nullptr, in_data, nullptr, s->info);
...
int RGWGetBucketReplication::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWGetBucketReplication::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWGetBucketReplication::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span =jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWPutBucketReplication::verify_permission(const jspan* const parent_span) {
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);

  return verify_bucket_owner_or_policy(s, rgw::IAM::s3PutReplicationConfiguration);
}

void RGWPutBucketReplication::execute(const jspan* const parent_span) {
...
void RGWDeleteBucketReplication::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}

int RGWDeleteBucketReplication::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  return verify_bucket_owner_or_policy(s, rgw::IAM::s3DeleteReplicationConfiguration);
}

void RGWDeleteBucketReplication::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  bufferlist in_data;
  op_ret = store->forward_request_to_master(s->user.get(), nullptr, in_data, nullptr, s->info);
...
int RGWOp::init_quota(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWGetObj::handle_user_manifest(const char *prefix, const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWGetObj::handle_slo_manifest(bufferlist& bl, const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWGetObj::get_data_cb(bufferlist& bl, off_t bl_ofs, off_t bl_len, const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWGetObj::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}
...
void RGWGetObj::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWGetObj::init_common(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  if (range_str) {
...
int RGWListBuckets::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWGetUsage::verify_permission(const jspan* const parent_span)
{
...
void RGWListBuckets::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWGetUsage::execute(const jspan* const parent_span)
{
...
int RGWStatAccount::verify_permission(const jspan* const parent_span)
{
...
void RGWStatAccount::execute(const jspan* const parent_span)
{
  string marker;
  rgw::sal::RGWBucketList buckets;
...
int RGWGetBucketVersioning::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  return verify_bucket_owner_or_policy(s, rgw::IAM::s3GetBucketVersioning);
}

void RGWGetBucketVersioning::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}

void RGWGetBucketVersioning::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWSetBucketVersioning::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWSetBucketVersioning::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}

void RGWSetBucketVersioning::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  op_ret = get_params(span.get());
  if (op_ret < 0)
...
int RGWGetBucketWebsite::verify_permission(const jspan* const parent_span)
{
  return verify_bucket_owner_or_policy(s, rgw::IAM::s3GetBucketWebsite);
}

void RGWGetBucketWebsite::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWGetBucketWebsite::execute(const jspan* const parent_span)
{
...
int RGWSetBucketWebsite::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  return verify_bucket_owner_or_policy(s, rgw::IAM::s3PutBucketWebsite);
}

void RGWSetBucketWebsite::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}

void RGWSetBucketWebsite::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWDeleteBucketWebsite::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  return verify_bucket_owner_or_policy(s, rgw::IAM::s3DeleteBucketWebsite);
}

void RGWDeleteBucketWebsite::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}

void RGWDeleteBucketWebsite::execute(const jspan* const parent_span)
{
  bufferlist in_data;
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWStatBucket::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWStatBucket::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}

void RGWStatBucket::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  if (!s->bucket_exists) {
    op_ret = -ERR_NO_SUCH_BUCKET;
...
int RGWListBucket::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWListBucket::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}

void RGWListBucket::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWGetBucketLogging::verify_permission(const jspan* const parent_span)
{
  return verify_bucket_owner_or_policy(s, rgw::IAM::s3GetBucketLogging);
}

int RGWGetBucketLocation::verify_permission(const jspan* const parent_span)
{
  return verify_bucket_owner_or_policy(s, rgw::IAM::s3GetBucketLocation);
}

int RGWCreateBucket::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWCreateBucket::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}
...
void RGWCreateBucket::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWDeleteBucket::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWDeleteBucket::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}

void RGWDeleteBucket::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWPutObj::init_processing(const jspan* const parent_span) {
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWPutObj::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWPutObj::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}
...
void RGWPutObj::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWPostObj::verify_permission(const jspan* const parent_span)
{
  return 0;
}

void RGWPostObj::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWPostObj::execute(const jspan* const parent_span)
{
  boost::optional<RGWPutObj_Compress> compressor;
  CompressorRef plugin;
  char supplied_md5[CEPH_CRYPTO_MD5_DIGESTSIZE * 2 + 1];
...
int RGWPutMetadataAccount::init_processing(const jspan* const parent_span)
{
...
int RGWPutMetadataAccount::verify_permission(const jspan* const parent_span)
{
  if (s->auth.identity->is_anonymous()) {
    return -EACCES;
  }
...
void RGWPutMetadataAccount::execute(const jspan* const parent_span)
{
...
int RGWPutMetadataBucket::verify_permission(const jspan* const parent_span)
{
  if (!verify_bucket_permission_no_policy(this, s, RGW_PERM_WRITE)) {
    return -EACCES;
  }
...
void RGWPutMetadataBucket::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWPutMetadataBucket::execute(const jspan* const parent_span)
{
  op_ret = get_params();
  if (op_ret < 0) {
    return;
...
int RGWPutMetadataObject::verify_permission(const jspan* const parent_span)
{
...
void RGWPutMetadataObject::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWPutMetadataObject::execute(const jspan* const parent_span)
{
  rgw_obj target_obj;
...
int RGWDeleteObj::handle_slo_manifest(bufferlist& bl, const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWDeleteObj::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWDeleteObj::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}

void RGWDeleteObj::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWCopyObj::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWCopyObj::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}

void RGWCopyObj::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWGetACLs::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  bool perm;
  if (!rgw::sal::RGWObject::empty(s->object.get())) {
...
void RGWGetACLs::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}

void RGWGetACLs::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  stringstream ss;
...
int RGWPutACLs::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  bool perm;
...
int RGWGetLC::verify_permission(const jspan* const parent_span)
{
  bool perm;
...
int RGWPutLC::verify_permission(const jspan* const parent_span)
{
  bool perm;
...
int RGWDeleteLC::verify_permission(const jspan* const parent_span)
{
  bool perm;
  perm = verify_bucket_permission(this, s, rgw::IAM::s3PutLifecycleConfiguration);
  if (!perm)
...
void RGWPutACLs::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}

void RGWGetLC::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWPutLC::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWDeleteLC::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWPutACLs::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  bufferlist bl;
...
void RGWPutLC::execute(const jspan* const parent_span)
{
  bufferlist bl;
...
void RGWDeleteLC::execute(const jspan* const parent_span)
{
  bufferlist data;
  op_ret = store->forward_request_to_master(s->user.get(), nullptr, data, nullptr, s->info);
  if (op_ret < 0) {
...
int RGWGetCORS::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  return verify_bucket_owner_or_policy(s, rgw::IAM::s3GetBucketCORS);
}

void RGWGetCORS::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWPutCORS::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  return verify_bucket_owner_or_policy(s, rgw::IAM::s3PutBucketCORS);
}

void RGWPutCORS::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWDeleteCORS::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWDeleteCORS::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  bufferlist data;
  op_ret = store->forward_request_to_master(s->user.get(), nullptr, data, nullptr, s->info);
...
void RGWOptionsCORS::execute(const jspan* const parent_span)
{
...
int RGWGetRequestPayment::verify_permission(const jspan* const parent_span)
{
  return verify_bucket_owner_or_policy(s, rgw::IAM::s3GetBucketRequestPayment);
}

void RGWGetRequestPayment::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWGetRequestPayment::execute(const jspan* const parent_span)
{
  requester_pays = s->bucket->get_info().requester_pays;
}

int RGWSetRequestPayment::verify_permission(const jspan* const parent_span)
{
  return verify_bucket_owner_or_policy(s, rgw::IAM::s3PutBucketRequestPayment);
}

void RGWSetRequestPayment::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWSetRequestPayment::execute(const jspan* const parent_span)
{
...
int RGWInitMultipart::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWInitMultipart::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}

void RGWInitMultipart::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWCompleteMultipart::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWCompleteMultipart::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}

void RGWCompleteMultipart::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWCompleteMultipart::complete(const jspan* const parent_span)
{
...
int RGWAbortMultipart::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  if (s->iam_policy || ! s->iam_user_policies.empty()) {
    auto usr_policy_res = eval_user_policies(s->iam_user_policies, s->env,
...
void RGWAbortMultipart::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}

void RGWAbortMultipart::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWListMultipart::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWListMultipart::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}

void RGWListMultipart::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  string meta_oid;
  RGWMPObj mp;
...
int RGWListBucketMultiparts::verify_permission(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWListBucketMultiparts::pre_exec(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
  rgw_bucket_object_pre_exec(s);
}

void RGWListBucketMultiparts::execute(const jspan* const parent_span)
{
  [[maybe_unused]] const auto span = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
void RGWGetHealthCheck::execute(const jspan* const parent_span)
{
...
int RGWDeleteMultiObj::verify_permission(const jspan* const parent_span)
{
  if (s->iam_policy || ! s->iam_user_policies.empty()) {
    auto usr_policy_res = eval_user_policies(s->iam_user_policies, s->env,
                                              boost::none,
...
void RGWDeleteMultiObj::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWDeleteMultiObj::execute(const jspan* const parent_span)
{
...
int RGWBulkDelete::verify_permission(const jspan* const parent_span)
{
  return 0;
}

void RGWBulkDelete::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWBulkDelete::execute(const jspan* const parent_span)
{
...
int RGWBulkUploadOp::verify_permission(const jspan* const parent_span)
{
  if (s->auth.identity->is_anonymous()) {
    return -EACCES;
  }
...
void RGWBulkUploadOp::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}
...
void RGWBulkUploadOp::execute(const jspan* const parent_span)
{
...
int RGWSetAttrs::verify_permission(const jspan* const parent_span)
{
...
void RGWSetAttrs::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWSetAttrs::execute(const jspan* const parent_span)
{
  op_ret = get_params();
  if (op_ret < 0)
    return;
...
void RGWGetObjLayout::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWGetObjLayout::execute(const jspan* const parent_span)
{
...
int RGWConfigBucketMetaSearch::verify_permission(const jspan* const parent_span)
{
...
void RGWConfigBucketMetaSearch::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWConfigBucketMetaSearch::execute(const jspan* const parent_span)
{
  op_ret = get_params();
  if (op_ret < 0) {
...
int RGWGetBucketMetaSearch::verify_permission(const jspan* const parent_span)
{
  if (!s->auth.identity->is_owner_of(s->bucket_owner.get_id())) {
    return -EACCES;
  }
...
void RGWGetBucketMetaSearch::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

int RGWDelBucketMetaSearch::verify_permission(const jspan* const parent_span)
{
  if (!s->auth.identity->is_owner_of(s->bucket_owner.get_id())) {
    return -EACCES;
  }
...
void RGWDelBucketMetaSearch::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWDelBucketMetaSearch::execute(const jspan* const parent_span)
{
...
int RGWHandler::do_init_permissions(const jspan* const parent_span)
{
...
int RGWHandler::do_read_permissions(RGWOp *op, bool only_bucket, const jspan* const parent_span)
{
  if (only_bucket) {
...
void RGWDefaultResponseOp::send_response(const jspan* const parent_span) {
  if (op_ret) {
...
void RGWPutBucketPolicy::send_response(const jspan* const parent_span)
{
  if (op_ret) {
    set_req_state_err(s, op_ret);
  }
...
int RGWPutBucketPolicy::verify_permission(const jspan* const parent_span)
{
...
int RGWPutBucketPolicy::get_params(const jspan* const parent_span)
{
...
void RGWPutBucketPolicy::execute(const jspan* const parent_span)
{
  op_ret = get_params();
  if (op_ret < 0) {
    return;
...
void RGWGetBucketPolicy::send_response(const jspan* const parent_span)
{
  if (op_ret) {
    set_req_state_err(s, op_ret);
  }
...
int RGWGetBucketPolicy::verify_permission(const jspan* const parent_span)
{
...
void RGWGetBucketPolicy::execute(const jspan* const parent_span)
{
  rgw::sal::RGWAttrs attrs(s->bucket_attrs);
...
void RGWDeleteBucketPolicy::send_response(const jspan* const parent_span)
{
  if (op_ret) {
    set_req_state_err(s, op_ret);
  }
...
int RGWDeleteBucketPolicy::verify_permission(const jspan* const parent_span)
{
...
void RGWDeleteBucketPolicy::execute(const jspan* const parent_span)
{
  op_ret = retry_raced_bucket_write(s->bucket.get(), [this] {
      rgw::sal::RGWAttrs attrs(s->bucket_attrs);
...
void RGWPutBucketObjectLock::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

int RGWPutBucketObjectLock::verify_permission(const jspan* const parent_span)
{
  return verify_bucket_owner_or_policy(s, rgw::IAM::s3PutBucketObjectLockConfiguration);
}

void RGWPutBucketObjectLock::execute(const jspan* const parent_span)
{
  if (!s->bucket->get_info().obj_lock_enabled()) {
...
void RGWGetBucketObjectLock::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

int RGWGetBucketObjectLock::verify_permission(const jspan* const parent_span)
{
  return verify_bucket_owner_or_policy(s, rgw::IAM::s3GetBucketObjectLockConfiguration);
}

void RGWGetBucketObjectLock::execute(const jspan* const parent_span)
{
  if (!s->bucket->get_info().obj_lock_enabled()) {
...
int RGWPutObjRetention::verify_permission(const jspan* const parent_span)
{
...
void RGWPutObjRetention::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWPutObjRetention::execute(const jspan* const parent_span)
{
  if (!s->bucket->get_info().obj_lock_enabled()) {
...
int RGWGetObjRetention::verify_permission(const jspan* const parent_span)
{
...
void RGWGetObjRetention::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWGetObjRetention::execute(const jspan* const parent_span)
{
  if (!s->bucket->get_info().obj_lock_enabled()) {
...
int RGWPutObjLegalHold::verify_permission(const jspan* const parent_span)
{
...
void RGWPutObjLegalHold::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWPutObjLegalHold::execute(const jspan* const parent_span) {
  if (!s->bucket->get_info().obj_lock_enabled()) {
...
int RGWGetObjLegalHold::verify_permission(const jspan* const parent_span)
{
...
void RGWGetObjLegalHold::pre_exec(const jspan* const parent_span)
{
  rgw_bucket_object_pre_exec(s);
}

void RGWGetObjLegalHold::execute(const jspan* const parent_span)
{
  if (!s->bucket->get_info().obj_lock_enabled()) {
    ldpp_dout(this, 0) << "ERROR: bucket object lock not configured" << dendl;
    op_ret = -ERR_INVALID_REQUEST;
...
void RGWGetClusterStat::execute(const jspan* const parent_span)
{
  op_ret = this->store->getRados()->get_rados_handle()->cluster_stat(stats_op);
}


int RGWGetBucketPolicyStatus::verify_permission(const jspan* const parent_span)
{
...
void RGWGetBucketPolicyStatus::execute(const jspan* const parent_span)
{
  isPublic = (s->iam_policy && rgw::IAM::is_public(*s->iam_policy)) || s->bucket_acl->is_public();
}

int RGWPutBucketPublicAccessBlock::verify_permission(const jspan* const parent_span)
{
...
int RGWPutBucketPublicAccessBlock::get_params(const jspan* const parent_span)
{
  const auto max_size = s->cct->_conf->rgw_max_put_param_size;
  std::tie(op_ret, data) = rgw_rest_read_all_input(s, max_size, false);
  return op_ret;
...
void RGWPutBucketPublicAccessBlock::execute(const jspan* const parent_span)
{
  RGWXMLDecoder::XMLParser parser;
  if (!parser.init()) {
    ldpp_dout(this, 0) << "ERROR: failed to initialize parser" << dendl;
...
int RGWGetBucketPublicAccessBlock::verify_permission(const jspan* const parent_span)
{
  if (!verify_bucket_permission(this, s, rgw::IAM::s3GetBucketPolicy)) {
    return -EACCES;
  }
...
void RGWGetBucketPublicAccessBlock::execute(const jspan* const parent_span)
{
...
void RGWDeleteBucketPublicAccessBlock::send_response(const jspan* const parent_span)
{
  if (op_ret) {
    set_req_state_err(s, op_ret);
  }
...
int RGWDeleteBucketPublicAccessBlock::verify_permission(const jspan* const parent_span)
{
  if (!verify_bucket_permission(this, s, rgw::IAM::s3PutBucketPublicAccessBlock)) {
    return -EACCES;
  }
...
void RGWDeleteBucketPublicAccessBlock::execute(const jspan* const parent_span)
{
  op_ret = retry_raced_bucket_write(s->bucket.get(), [this] {
      rgw::sal::RGWAttrs attrs(s->bucket_attrs);
