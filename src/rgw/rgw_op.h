...
protected:
  ...
  int do_init_permissions(const jspan* const parent_span = nullptr);
  int do_read_permissions(RGWOp* op, bool only_bucket, const jspan* const parent_span = nullptr);
...
public:
  ...
  virtual int init_permissions(RGWOp*, const jspan* const parent_span = nullptr) {
    return 0;
  }
  ...
  virtual int read_permissions(RGWOp* op, const jspan* const parent_span = nullptr) = 0;
...
protected:
  ...
  virtual int init_quota(const jspan* const parent_span = nullptr);
...
public:
  ...
  virtual int init_processing(const jspan* const parent_span = nullptr) {
  ...
  virtual int verify_permission(const jspan* const parent_span = nullptr) = 0;
  virtual int verify_op_mask(const jspan* const parent_span = nullptr);
  virtual void pre_exec(const jspan* const parent_span = nullptr) {}
  virtual void execute(const jspan* const parent_span = nullptr) = 0;
  virtual void send_response(const jspan* const parent_span = nullptr) {}
  virtual void complete(const jspan* const parent_span = nullptr) {
...
public:
  ...
  void pre_exec(const jspan* const parent_span = nullptr) override;
  ...
  int handle_user_manifest(const char *prefix, const jspan* const parent_span = nullptr);
  int handle_slo_manifest(bufferlist& bl, const jspan* const parent_span = nullptr);

  int get_data_cb(bufferlist& bl, off_t ofs, off_t len, const jspan* const parent_span = nullptr);

  virtual int get_params(const jspan* const parent_span = nullptr) = 0;
  virtual int send_response_data_error(const jspan* const parent_span = nullptr) = 0;
  virtual int send_response_data(bufferlist& bl, off_t ofs, off_t len, const jspan* const parent_span = nullptr) = 0;
...
class RGWGetObjTags : public RGWOp {
 ...
 public:
  ...
  virtual void send_response_data(bufferlist& bl, const jspan* const parent_span = nullptr) = 0;
...
class RGWPutObjTags : public RGWOp {
 ...
 public:
  ...
  virtual void send_response(const jspan* const parent_span = nullptr) override = 0;
  virtual int get_params(const jspan* const parent_span = nullptr) = 0;
...
public:
  ...
  virtual void send_response_data(const jspan* const parent_span = nullptr) = 0;
...
public:
  ...
  virtual int get_data(std::list<acct_path_t>& items,
                       bool * is_truncated) = 0;
  void send_response(const jspan* const parent_span = nullptr) override = 0;
...
public:
  ...
  virtual void send_response_begin(bool has_buckets, const jspan* const parent_span = nullptr) = 0;
  virtual void send_response_data(rgw::sal::RGWBucketList& buckets, const jspan* const parent_span = nullptr) = 0;
  virtual void send_response_end(const jspan* const parent_span = nullptr) = 0;
  void send_response(const jspan* const parent_span = nullptr) override {}
...
public:
  ...
  virtual int get_params(const jspan* const parent_span = nullptr) { return 0; }
...
public:
  ...
  virtual int init_processing(const jspan* const parent_span = nullptr) override;
...
public:
  ...
  int init_processing(const jspan* const parent_span = nullptr) override;
  int verify_permission(const jspan* const parent_span = nullptr) override;
  void pre_exec(const jspan* const parent_span = nullptr) override { }
  void execute(const jspan* const parent_span = nullptr) override;
...
public:
  ...
  int verify_permission(const jspan* const parent_span = nullptr) override;
  void pre_exec(const jspan* const parent_span = nullptr) override;
  void execute(const jspan* const parent_span = nullptr) override = 0;
...
public:
  ...
  int verify_permission(const jspan* const parent_span = nullptr) override {return 0;}
...
public:
  ...
  void pre_exec(const jspan* const parent_span = nullptr) override;
  void execute(const jspan* const parent_span = nullptr) override;
  void complete(const jspan* const parent_span = nullptr) override;
...
extern int rgw_build_bucket_policies(rgw::sal::RGWRadosStore* store, struct req_state* s, const jspan* const parent_span = nullptr);
extern int rgw_build_object_policies(rgw::sal::RGWRadosStore *store, struct req_state *s,
				     bool prefetch_data, const jspan* const parent_span = nullptr);
...
public:
  ...
  void execute(const jspan* const parent_span = nullptr) override;
  int get_params(const jspan* const parent_span = nullptr);
...
public:
  ...
  void pre_exec(const jspan* const parent_span = nullptr) override;
  void execute(const jspan* const parent_span = nullptr) override;
  virtual void send_response(const jspan* const parent_span = nullptr) = 0;
  virtual int get_params(const jspan* const parent_span = nullptr) = 0;
