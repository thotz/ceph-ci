...
public:
  ...
  void send_response_data_reversed(rgw::sal::RGWBucketList& buckets, const jspan* const parent_span = nullptr);
...
public:
  ...
  int get_params(const jspan* const parent_span = nullptr) override;
  void send_response(const jspan* const parent_Span) override;
...
public:
  ...
  int read_permissions(RGWOp *, const jspan* const parent_span = nullptr) override {
    return 0;
  }
