...
std::vector<Option> get_mds_client_options() {
  return std::vector<Option>({
    ...
    .add_service("osd")
    .set_flag(Option::FLAG_RUNTIME)
    .set_description("Compression policy to use in MSGR for communicating with OSD")
    ...
    .add_service("osd")
    .set_flag(Option::FLAG_RUNTIME)
    .set_description("Compression algorithm to use in MSGR when communicating with OSD")
    .add_see_also("ms_osd_compress_mode"),
